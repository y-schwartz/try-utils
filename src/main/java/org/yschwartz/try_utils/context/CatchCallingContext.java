 ...
 *
 * @param <E>
 *            the type of exception that should be caught
 * @param <R>
...
public class CatchCallingContext<E extends Exception, R> extends BaseCatchContext<E, R> {
	 ...
	 *
	 * @param exceptionToValueFunction
	 *            the function that receives the caught exception and returns a
	 *            result value
	 * @return the TryCallingContext for defining the remaining blocks
	 */
	 ...
	 *            the exception mapper from the caught exception to a new exception
	 * @return the TryCallingContext for defining the remaining blocks
	 */
